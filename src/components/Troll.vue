<template>
     <h1 class="text-lg text-white font-bold p-3 bg-slate-700/50 w-fit rounded-sm hover:bg-slate-600 fixed">BETA</h1>

     <div class="flex justify-center items-center min-h-screen">
          <div v-if="props.selectedPlayer" class="border-[3px] border-slate-600 p-8">
               
               <div class="relative">
                    <h1 class="text-lg font-bold text-white absolute -top-12 right-14">TROLL MENU</h1>
               </div>
